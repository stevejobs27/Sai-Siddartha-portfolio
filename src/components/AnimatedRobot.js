    ...
    <div className="animated-robot-container">
      ...
      <div className="svg-box" style={{ width: 800, height: 600, position: "absolute", zIndex: 10 }}>
        <svg ref={svgRef} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
          ...
          <g id="Ship">
            <g id="mid-display">
              <rect width="320.3" height="207" x="248.8" y="116.3" fill="#282e39" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" opacity=".8" rx="18.4" />
              <g id="graph-btm">
                <path id="graph-left" fill="#64D98A" d="M439.7 292.1s4.5-19.4 8.7-19c3.6.3 4.6 9.2 7.3 9 3.4-.2 4-14 7.3-14.3 3-.2 4.7 10 8.3 10 4 0 5.1-12.6 8.8-12.8 4.1-.2 7.2 27.1 7.2 27.1z" />
              ...
              <g id="planet">
                ...
                <ellipse id="planet-circle" cx="331.5" cy="207.8" fill="none" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" rx="61.8" ry="12.7" />
              ...
              <g className="graph-circle-lb" id="graph-cir-left">
                ...
                <path fill="#64D98A" d="M290.4 287.5l5.3-20.1a20.8 20.8 0 0115.5 20z" />
              </g>
              <g className="graph-circle-lb" id="graph-cir-mid">
                <circle cx="345.4" cy="287.5" r="20.8" fill="#34496a" />
                <path fill="#64D98A" d="M345.4 287.5l5.2-20.1a20.8 20.8 0 0115.5 20z" />
              </g>
              <g id="graph-cir">
                ...
                <circle id="graph-cir-1" cx="408" cy="292.1" r="2.3" fill="#64D98A" />
                <circle id="graph-cir-2" cx="396.4" cy="275.7" r="2.3" fill="#64D98A" />
                <circle id="graph-cir-3" cx="417.2" cy="292.1" r="2.3" fill="#64D98A" />
                <circle id="graph-cir-mid-2" cx="396.4" cy="292.1" r="2.3" fill="#64D98A" data-name="graph-cir-mid" />
              </g>
              <g id="graph-big" clipPath="url(#clip-path)">
                <path id="graph-line" fill="none" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" d="M439.7 206.4c26.3 0 26.3 34.2 52.6 34.2s26.3-34.2 52.6-34.2 26.3 34.2 52.6 34.2 26.3-34.2 52.6-34.2" />
              </g>
              <circle cx="275.7" cy="139.7" r="11.8" fill="#34496a" />
              <circle id="left-top-circle" cx="275.7" cy="139.7" r="11.8" fill="#64D98A" />
              ...
              <path className="circles-top" id="circle-l" fill="none" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" d="M448 148.2a13.3 13.3 0 11-13.2 13.3 13.3 13.3 0 0113.3-13.3" />
              <circle cx="491.2" cy="161.4" r="13.3" fill="none" stroke="#34496a" strokeMiterlimit="10" strokeWidth="5" />
              <path className="circles-top" id="circle-m" fill="none" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" d="M491.2 148.2a13.3 13.3 0 11-13.3 13.3 13.3 13.3 0 0113.3-13.3" />
              <circle cx="534.4" cy="161.4" r="13.3" fill="none" stroke="#34496a" strokeMiterlimit="10" strokeWidth="5" />
              <path className="circles-top" id="circle-r" fill="none" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" d="M534.4 148.2a13.3 13.3 0 11-13.3 13.3 13.3 13.3 0 0113.3-13.3" />
            </g>
            <g id="btm-display">
              <g id="right-display">
                <g id="right-display-display">
                  <path fill="#282e39" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" d="M654.7 461H508.6c-10.5 0-15.8-8.5-12-19l26.2-72a29.9 29.9 0 0125.8-18.9h146c10.5 0 15.8 8.5 12 19l-26.2 72a29.9 29.9 0 01-25.7 18.8z" opacity=".8" />
                  <g id="bars">
                    <polygon id="bar-3-btm" fill="#34496a" points="656.9 441.2 642.4 441.2 667.6 371.7 682.2 371.7 656.9 441.2" />
                    <polygon id="bar-3-top" fill="#64D98A" points="656.9 441.2 642.4 441.2 653 412 667.5 412 656.9 441.2" />
                    <polygon id="bar-2-btm" fill="#34496a" points="633.7 441.2 619.2 441.2 644.5 371.7 659 371.7 633.7 441.2" />
                    <polygon id="bar-2-top" fill="#64D98A" points="633.7 441.2 619.2 441.2 636 395.1 650.5 395.1 633.7 441.2" />
                    <polygon id="bar-1-btm" fill="#34496a" points="610.6 441.2 596.1 441.2 621.4 371.7 635.9 371.7 610.6 441.2" />
                    <polygon id="bar-1-top" fill="#64D98A" points="610.6 441.2 596.1 441.2 604 419.5 618.5 419.5 610.6 441.2" />
                  </g>
                  <g id="btns" fill="#64D98A">
              ...
              <g id="left-display">
                <g id="left-display-display">
                  <path fill="#282e39" stroke="#64D98A" strokeMiterlimit="10" strokeWidth="5" d="M299 461H153c-10.4 0-22-8.5-25.8-19L101 370c-3.8-10.4 1.6-18.9 12-18.9h146c10.5 0 22 8.5 25.9 18.9l26.2 72c3.8 10.4-1.6 19-12 19z" opacity=".8" />
                  <polygon fill="#64D98A" points="153.1 433.3 155.7 440.3 158.2 447.3 153.6 443.8 148.9 440.3 151 436.8 153.1 433.3" />
                  <polygon fill="#64D98A" points="143 433.3 146.4 433.3 151.9 448.4 148.5 448.4 143 433.3" />
                  <polygon fill="#64D98A" points="193.8 448.4 191.3 441.4 188.7 434.4 193.4 437.9 198 441.4 195.9 444.9 193.8 448.4" />
                  <polygon fill="#64D98A" points="203.9 448.4 200.6 448.4 195.1 433.3 198.4 433.3 203.9 448.4" />
                  <polygon fill="#64D98A" points="164.4 433.3 167.8 433.3 173.3 448.4 169.9 448.4 164.4 433.3" />
                  <polygon fill="#64D98A" points="174 433.3 177.4 433.3 182.9 448.4 179.5 448.4 174 433.3" />
                  <ellipse cx="199" cy="377.7" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 199 377.7)" />
                  <polygon fill="#64D98A" points="198.2 380.9 197 377.7 195.9 374.6 199.2 376.1 202.6 377.7 200.4 379.3 198.2 380.9" />
                  <line x1="217.3" x2="267.5" y1="377.7" y2="377.7" fill="#282e39" stroke="#64D98A" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5" opacity=".8" />
                  <ellipse cx="206.2" cy="397.6" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 206.2 397.6)" />
                  <polygon fill="#64D98A" points="205.4 400.7 204.2 397.6 203.1 394.4 206.4 396 209.8 397.6 207.6 399.2 205.4 400.7" />
                  <line x1="224.5" x2="274.8" y1="397.6" y2="397.6" fill="#282e39" stroke="#64D98A" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5" opacity=".8" />
                  <ellipse cx="213.5" cy="417.5" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 213.4 417.4)" />
                  <polygon fill="#64D98A" points="212.6 420.6 211.5 417.5 210.3 414.3 213.7 415.9 217 417.5 214.8 419 212.6 420.6" />
                  <line x1="231.8" x2="282" y1="417.5" y2="417.5" fill="#282e39" stroke="#64D98A" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5" opacity=".8" />
                  <ellipse cx="220.7" cy="437.3" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 220.7 437.3)" />
                  <polygon fill="#64D98A" points="219.8 440.5 218.7 437.3 217.6 434.2 220.9 435.8 224.3 437.3 222.1 438.9 219.8 440.5" />
                  <line x1="239" x2="289.2" y1="437.3" y2="437.3" fill="#282e39" stroke="#64D98A" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="5" opacity=".8" />
                ...
                <g clipPath="url(#clip-path-2)">
                  <g id="faces">
                    <g id="face">
                      ...
                      <g className="eyes" id="eyes" fill="#64D98A">
                    ...
                    <g id="face-2" data-name="face">
                      ...
                      <g className="eyes" id="eyes-2" fill="#64D98A" data-name="eyes">
